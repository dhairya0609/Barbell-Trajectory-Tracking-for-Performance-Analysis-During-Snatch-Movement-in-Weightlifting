...
class pathTracker(object):
    def __init__(self, windowName = 'default window', videoName = "default video"):
        ...
        self.tracker_type = self.tracker_types[4]
    ...
    def drawing(self,image,x,y,w,h,timer):
        ...
        self.coordinates.append((center_point_x, center_point_y))
        # tracker's bound
    ...
    def save_coordinates_to_csv(self):
        with open('trajectory_coordinates.csv', mode='w', newline='') as file:
            writer = csv.writer(file)
            writer.writerow(['X', 'Y'])  
            writer.writerows(self.coordinates)
        print("Coordinates saved to 'trajectory_coordinates.csv'.")

if __name__ == '__main__':
    myTracker = pathTracker(windowName = 'myTracker',videoName = "barbell-path-tracker-master\\barbell-path-tracker-master\Video\GX010680_male.mp4")
